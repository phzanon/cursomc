...
import com.pedrozanon.cursomc.services.PedidoService;
...
public class PedidoResource {
	...
	public ResponseEntity<Page<Pedido>> findPage(@RequestParam(value="page", defaultValue="0")Integer page,
			...
			@RequestParam(value="direction", defaultValue="DESC") String dir) {
		
		Page<Pedido> list = service.findPage(page, linesPerPage, orderBy, dir);
